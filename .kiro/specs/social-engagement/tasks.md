...
- [ ] 1. Database schema extensions for engagement tracking
...
- [-] 2. Backend utility functions
  ...
  - [-] 2.6 Write property test for hotness score
...
- [ ] 4. Database operations for engagement
  - [ ] 4.1 Implement vote database operations
  ...
  - [ ] 4.2 Write property tests for vote operations
  ...
  - [ ] 4.3 Implement event log database operations
...
- [ ] 6. tRPC engagement router
  ...
  - [ ] 6.3 Implement analytics tracking endpoints
  ...
  - [ ] 6.4 Implement trending/popular endpoints
    - Add getTrending query
    - Add getPopular query with period parameter
    - Add getHot query
    - _Requirements: 5.2, 5.3_

  - [ ] 6.5 Implement activity feed endpoint
